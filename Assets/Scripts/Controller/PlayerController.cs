...
public class PlayerController : MonoBehaviour
{
    ...
    [Tooltip("The speed at which the player rotates to look left and right in degrees")]
    ...
    [Header("jump timing")]
    public float jumpTimeLeniancy = 0.1f;
    ...
    void ProcessMovement()
    {
        ...
        float forwardBackwordInput = inputManager.verticalMoveAxis;
        ...
        if (controller.isGrounded)
        {
            ...
            timetoStopBeingLenient = Time.time + jumpTimeLeniancy;
            //set the movement direction to be the received input, set y to 0 since we are on the ground
            moveDirection = new Vector3(leftRightInput, 0, forwardBackwordInput);
            //set move direction relative to the transform
        ...
        {
            moveDirection = new Vector3(leftRightInput * moveSpeed, moveDirection.y, forwardBackwordInput * moveSpeed);
            moveDirection = transform.TransformDirection(moveDirection);
